...
-- users
INSERT INTO users (id, about, activation_code, active, birthday, email, full_name, location, notifications_count, password, password_reset_code, profile_customized, profile_started, registration_date, role, tweet_count, username, website, like_count, media_tweet_count, country, gender, language, muted_direct_messages, phone, private_profile, country_code, background_color, color_scheme) VALUES (1, 'Hello2', null, true, null, 'merikbest2015@gmail.com', 'Vbhjckfd1', 'Kyiv', 0, '$2a$08$1D3LToUL9ccJYqGDZNPH8uvTBwVFou5MobYvtgAakra6WdACQZWJK', null, true, true, '2021-08-01 23:34:32.000000', 'USER', 126, 'Vbhjckfd1', 'https://www.google.com', 40, 44, 'UA', 'Cat', 'Ukrainian - українська', true, 666966623, false, 'UA', 'DEFAULT', 'BLUE');
