...
public class UserControllerTest {
    ...
    public void getUserById() throws Exception { // UserProfileResponse
        mockMvc.perform(get(URL_USER_BASIC + "/1"))
                ...
                .andExpect(jsonPath("$.website").value("https://www.google.com"))
    ...
    public void getUserMediaTweets() throws Exception {
        mockMvc.perform(get(URL_USER_BASIC + "/" + USER_ID + "/media"))
                ...
                .andExpect(jsonPath("$[0].text").value("https://www.youtube.com/watch?v=ewZZNeYDiLo&ab_channel=TeamSESH"))
                ...
                .andExpect(jsonPath("$[0].addressedTweetId").isEmpty())
                .andExpect(jsonPath("$[0].replyType").value("EVERYONE"))
                .andExpect(jsonPath("$[0].link").value("https://www.youtube.com/watch?v=ewZZNeYDiLo&ab_channel=TeamSESH"))
                .andExpect(jsonPath("$[0].linkTitle").value("Bones - RestInPeace"))
                .andExpect(jsonPath("$[0].linkDescription").isEmpty())
                .andExpect(jsonPath("$[0].linkCover").value("https://i.ytimg.com/vi/ewZZNeYDiLo/mqdefault.jpg"))
                .andExpect(jsonPath("$[0].linkCoverSize").isEmpty())
...
//                .andExpect(status().isOk());
    ...
    public void getBlockList() throws Exception {
        mockMvc.perform(get(URL_USER_BASIC + "/blocked"))
                ...
                .andExpect(jsonPath("$[0].fullName").value("MrCat"))
                .andExpect(jsonPath("$[0].username").value("MrCat"))
                .andExpect(jsonPath("$[0].about").value("Hello twitter!"))
