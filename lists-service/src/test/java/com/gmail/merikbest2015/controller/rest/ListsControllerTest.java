...
public class ListsControllerTest {
    ...
    public void getAllTweetLists() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS)
    ...
    public void getUserTweetLists() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.USER)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getUserTweetListsById() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.USER_USER_ID, TestConstants.USER_ID)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getTweetListsWhichUserIn() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.USER_CONSIST)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
    ...
    public void getUserPinnedLists() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.PINED)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getListById() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID, 4)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getOwnerPrivateListById() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID, 6)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getFollowedPrivateListById() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID, 7)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getPrivateListById_NotFound() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID, 8)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
    ...
    public void getListById_NotFound() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + "/99")
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", is(ListsErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void getBlockedUserByListId() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID, 10)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
    ...
    public void getPrivateUserProfileByListId() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID, 11)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
    ...
    public void createTweetList() throws Exception {
        ...
        mockMvc.perform(post(PathConstants.UI_V1_LISTS)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
...
//    }
    ...
    public void editTweetList() throws Exception {
        ...
        mockMvc.perform(put(PathConstants.UI_V1_LISTS)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
                        .content(mapper.writeValueAsString(listsRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
...
//    }
    ...
    public void deleteList() throws Exception {
        mockMvc.perform(delete(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID, 4)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void deleteList_ShouldNotFound() throws Exception {
        mockMvc.perform(delete(PathConstants.UI_V1_LISTS + "/99")
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", is(ListsErrorMessage.LIST_NOT_FOUND)));
    }
...
//        mockMvc.perform(delete(PathConstants.UI_V1_LISTS + LIST_ID, 5)
//                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
//                .andExpect(status().isNotFound())
//                .andExpect(jsonPath("$", is(LIST_OWNER_NOT_FOUND)));
//    }
    ...
    public void followList() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.FOLLOW_LIST_ID, 9)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void followList_ShouldListNotFound() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.FOLLOW_LIST_ID, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", is(ListsErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void followList_ShouldFollowToPrivateListNotFound() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.FOLLOW_LIST_ID, 8)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", is(ListsErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void unfollowList() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.FOLLOW_LIST_ID, 4)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(4))
                .andExpect(jsonPath("$.listName").value(TestConstants.LIST_NAME))
    ...
    public void pinList() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.PIN_LIST_ID, 6)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(6))
                .andExpect(jsonPath("$.listName").value(TestConstants.LIST_NAME))
    ...
    public void unpinList() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.PIN_LIST_ID, 4)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(4))
                .andExpect(jsonPath("$.listName").value(TestConstants.LIST_NAME))
    ...
    public void pinList_ShouldPinnedListNotFound() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.PIN_LIST_ID, 8)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", is(ListsErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void getListsToAddUser() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.ADD_USER_USER_ID, 1)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(2)))
    ...
    public void addUserToLists() throws Exception {
        ...
        mockMvc.perform(post(PathConstants.UI_V1_LISTS + PathConstants.ADD_USER)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID)
                        .content(mapper.writeValueAsString(userToListsRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$").value(ListsSuccessMessage.USER_ADDED_TO_LISTS));
    }
    ...
    public void addUserToList() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.ADD_USER_LIST_ID, 1, 6)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void addUserToList_ShouldUserIsBlocked() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.ADD_USER_LIST_ID, 4, 6)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", is(String.format(ListsErrorMessage.USER_ID_BLOCKED, 4))));
    }
    ...
    public void addUserToList_ShouldUserHavePrivateProfile() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.ADD_USER_LIST_ID, 3, 6)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", is(ErrorMessage.USER_NOT_FOUND)));
    }
    ...
    public void addUserToList_ShouldUserBlockedMyProfile() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.ADD_USER_LIST_ID, 6, 6)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", is(String.format(ListsErrorMessage.USER_ID_BLOCKED, 2))));
    }
    ...
    public void addUserToList_ShouldListNotFound() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.ADD_USER_LIST_ID, 7, 99)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", is(ListsErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void removeUserFromList() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.ADD_USER_LIST_ID, 1, 4)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
    ...
    public void getTweetsByListId() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_TWEETS, 4)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
                .andExpect(jsonPath("$[0].id").value(45L))
                .andExpect(jsonPath("$[0].text").value("media tweet test"))
                .andExpect(jsonPath("$[0].createdAt").value("2021-10-03T20:38:51"))
    ...
    public void getTweetsByUserPrivateListId() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_TWEETS, 5)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", is(ListsErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void getListDetails() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_DETAILS, 4)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(4))
                .andExpect(jsonPath("$.listName").value(TestConstants.LIST_NAME))
    ...
    public void getListDetailsByUserPrivateList() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_DETAILS, 5)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", is(ListsErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void getListFollowers() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_FOLLOWERS, 4, 2)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
    ...
    public void getListFollowers_ShouldListNotFound() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_FOLLOWERS, 99, 2)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", is(ListsErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void getListFollowers_ByPrivateListShouldListNotFound() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_FOLLOWERS, 5, 1)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", is(ListsErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void getListFollowers_ByBlockedUserAndListNotFound() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_FOLLOWERS, 10, 5)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", is(String.format(ListsErrorMessage.USER_ID_BLOCKED, 2))));
    }
    ...
    public void getListMembers() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_MEMBERS, 4, 2)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
                .andExpect(jsonPath("$[0].id").value(1L))
    ...
    public void getListMembersByAnotherUser() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_MEMBERS, 9, 1)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*]", hasSize(1)))
                .andExpect(jsonPath("$[0].id").value(1L))
    ...
    public void getListMembers_ShouldListNotFound() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_MEMBERS, 99, 2)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", is(ListsErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void getListMembers_ByPrivateListShouldListNotFound() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_MEMBERS, 5, 1)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$", is(ListsErrorMessage.LIST_NOT_FOUND)));
    }
    ...
    public void getListMembers_ByBlockedUserAndListNotFound() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.LIST_ID_MEMBERS, 10, 5)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$", is(String.format(ListsErrorMessage.USER_ID_BLOCKED, 2))));
    }
    ...
    public void searchListMembersByUsername() throws Exception {
        mockMvc.perform(get(PathConstants.UI_V1_LISTS + PathConstants.SEARCH_LIST_ID, 2, TestConstants.USERNAME)
                        .header(PathConstants.AUTH_USER_ID_HEADER, TestConstants.USER_ID))
                .andExpect(status().isOk())
