...
export const API_USER_TWEETS = (userId: string) => `${API_ENDPOINT}/user/${userId}/tweets`;
export const API_USER_LIKED = (userId: string) => `${API_ENDPOINT}/user/${userId}/liked`;
export const API_USER_MEDIA = (userId: string) => `${API_ENDPOINT}/user/${userId}/media`;
export const API_USER_REPLIES = (userId: string) => `${API_ENDPOINT}/user/${userId}/replies`;
