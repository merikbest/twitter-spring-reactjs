...
export const selectIsTagsLoaded = (state: RootState): boolean => selectTagsLoadingState(state) === LoadingStatus.LOADED;
...
export const selectIsTrendsLoaded = (state: RootState): boolean => selectTrendsLoadingState(state) === LoadingStatus.LOADED;
