...
import {mockBookmarks, mockUser} from "../../../util/mockData/mockBookmarks";
...
describe("Bookmarks", () => {
    ...
    const mockTweetsState = {items: mockBookmarks, pagesCount: 1, loadingState: LoadingStatus.LOADING};
