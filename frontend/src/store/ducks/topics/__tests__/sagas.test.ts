...
describe("topicsSaga:", () => {
    ...
    describe("processNotInterestedTopicRequest:", () => {
        ...
        testSetResponse(worker, true, setNotInterestedTopic,{topicsId: 2, isTopicNotInterested: undefined}, "TopicResponse");
        testLoadingStatus(worker, setTopicsLoadingState, LoadingStatus.ERROR)
    });
    ...
    testWatchSaga(topicsSaga, [
        ...
        {actionType: TopicsActionsType.FETCH_FOLLOWED_TOPICS_BY_USER_ID, workSaga: fetchFollowedTopicsByUserIdRequest},
