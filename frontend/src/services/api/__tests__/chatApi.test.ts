...
describe("ChatApi", () => {
    ...
    describe("should fetch ChatApi.getChatMessages", () => {
        it("[200] should create chat Success", () => {
            testApiCall(mockAdapter, "onGet", API_CHAT_MESSAGES(1), 200, mockMessages, ChatApi.getChatMessages, 1);
        });
    });

    describe("should fetch ChatApi.readChatMessages", () => {
        it("[200] should read chat messages Success", () => {
            testApiCall(mockAdapter, "onGet", API_CHAT_READ_MESSAGES(1), 200, 7, ChatApi.readChatMessages, 1);
        });
    });
    ...
    describe("should fetch ChatApi.addMessage", () => {
        ...
        it("[404] should chat not found", () => {
            testApiCall(mockAdapter, "onPost", API_CHAT_ADD_MESSAGE, 404, mockChatErrorResponse, ChatApi.addMessage, mockChatMessage);
        });

        it("[404] should participant not found", () => {
            testApiCall(mockAdapter, "onPost", API_CHAT_ADD_MESSAGE, 404, mockUserErrorResponse, ChatApi.addMessage, mockChatMessage);
        });

        it("[400] should participant is blocked", () => {
            testApiCall(mockAdapter, "onPost", API_CHAT_ADD_MESSAGE, 400, mockUserBlockedErrorResponse, ChatApi.addMessage, mockChatMessage);
        });
    });
    ...
    describe("should fetch ChatApi.getParticipant", () => {
        ...
        it("[200] should get participant Success", () => {
            testApiCall(mockAdapter, "onGet", mockURL, 200, mockUsers[0], ChatApi.getParticipant, mockRequest);
        });

        it("[404] should chat not found", () => {
            testApiCall(mockAdapter, "onGet", mockURL, 404, mockChatErrorResponse, ChatApi.getParticipant, mockRequest);
        });

        it("[404] should participant not found", () => {
            testApiCall(mockAdapter, "onGet", mockURL, 404, mockUserErrorResponse, ChatApi.getParticipant, mockRequest);
        });
    });
    ...
    describe("should fetch ChatApi.leaveFromConversation", () => {
        ...
        it("[404] should chat not found", () => {
            testApiCall(mockAdapter, "onGet", mockURL, 404, mockChatErrorResponse, ChatApi.leaveFromConversation, mockRequest);
        });

        it("[404] should participant not found", () => {
            testApiCall(mockAdapter, "onGet", mockURL, 404, mockUserErrorResponse, ChatApi.leaveFromConversation, mockRequest);
        });
    });
