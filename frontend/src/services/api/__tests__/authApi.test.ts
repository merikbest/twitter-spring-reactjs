...
describe("AuthApi", () => {
    ...
    //         testApiCall(mockAdapter, "onPost", API_AUTH_LOGIN, 200, mockAuthUserResponse, AuthApi.login, mockRequest);
    //     });
    //
    //     it("[404] should User not found", () => {
    //         testApiCall(mockAdapter, "onPost", API_AUTH_LOGIN, 404, mockUserErrorResponse, AuthApi.login, mockRequest);
    //     });
    //
    //     it("[403] Incorrect password or email", () => {
    //         testApiCall(mockAdapter, "onPost", API_AUTH_LOGIN, 403, mockPasswordErrorResponse, AuthApi.login, mockRequest);
    //     });
    // });
    ...
    //         testApiCall(mockAdapter, "onPost", API_AUTH_REGISTRATION_CHECK, 200, mockResponse, AuthApi.registration, mockRequest);
    //     });
    //
    //     it("[403] should return email error", () => {
    //         testApiCall(mockAdapter, "onPost", API_AUTH_REGISTRATION_CHECK, 403, mockErrorResponse, AuthApi.registration, mockRequest);
    //     });
    // });
    ...
    //         testApiCall(mockAdapter, "onPost", API_AUTH_FORGOT_EMAIL, 200, mockResponse, AuthApi.getExistingEmail, mockRequest);
    //     });
    //
    //     it("[404] should email not found", () => {
    //         testApiCall(mockAdapter, "onPost", API_AUTH_FORGOT_EMAIL, 404, mockError, AuthApi.getExistingEmail, mockRequest);
    //     });
    // });
    ...
    //         testApiCall(mockAdapter, "onGet", mockUrl, 200, mockResponse, AuthApi.getUserByPasswordResetCode, mockRequest);
    //     });
    //
    //     it("[400] should password reset bad request", () => {
    //         testApiCall(mockAdapter, "onGet", mockUrl, 400, mockErrorResponse, AuthApi.getUserByPasswordResetCode, mockRequest);
    //     });
    // });
