...
describe("PollApi", () => {
    ...
    describe("should fetch PollApi.createPoll", () => {
        ...
        it("[200] should create poll Success", () => {
            testApiCall(mockAdapter, "onPost", UI_V1_TWEETS_POOL, 200, mockFullTweet, PollApi.createPoll, mockPoll);
        });
    });
    ...
    describe("should fetch PollApi.voteInPoll", () => {
        ...
        it("[200] should vote in poll Success", () => {
            testApiCall(mockAdapter, "onPost", UI_V1_TWEETS_VOTE, 200, mockFullTweet, PollApi.voteInPoll, mockVote);
        });

        it("[404] should return tweet Not Found", () => {
            testApiCall(mockAdapter, "onPost", UI_V1_TWEETS_VOTE, 404, tweetNotFoundError, PollApi.voteInPoll, mockVote);
        });
    });
});
