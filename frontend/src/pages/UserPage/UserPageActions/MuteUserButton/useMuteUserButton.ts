...
export const useMuteUserButton = (onCloseUserPageActions: () => void) => {
    ...
    }, [dispatch, userProfileId, username, isUserMuted, t, onCloseUserPageActions]);

    return { isUserMuted, username, handleMuteUser };
};
