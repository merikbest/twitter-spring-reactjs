...
public class UserControllerTest {
    ...
    public void getUserById() throws Exception {
        mockMvc.perform(get(UI_V1_USER + USER_ID, 1)
                ...
                .andExpect(jsonPath("$.followersCount").value(2L))
                .andExpect(jsonPath("$.followingCount").value(1L))
    ...
    public void updateUserProfile() throws Exception {
        ...
        mockMvc.perform(put(UI_V1_USER)
                ...
                .andExpect(jsonPath("$.followersCount").value(2L))
                .andExpect(jsonPath("$.followingCount").value(1L))
                .andExpect(jsonPath("$.followerRequestsCount").value(1L))
    ...
    public void getUserDetails() throws Exception {
        mockMvc.perform(get(UI_V1_USER + DETAILS_USER_ID, 3)
                ...
                .andExpect(jsonPath("$.avatar").value(TestConstants.AVATAR_SRC_1))
                .andExpect(jsonPath("$.followersCount").value(0L))
                .andExpect(jsonPath("$.followingCount").value(0L))
