...
import static com.gmail.merikbest2015.commons.constants.KafkaTopicConstants.MUTE_USER_TOPIC;
...
public class MuteUserProducer {
    ...
    public void sendMuteUserEvent(User user, Long authUserId, boolean hasUserMuted) {
        ...
        kafkaTemplate.send(ProducerUtil.authHeaderWrapper(MUTE_USER_TOPIC, event, authUserId));
    }
}
