-- users
INSERT INTO users(id, email, full_name, username, private_profile, active, about, avatar, muted_direct_messages, pinned_tweet_id) VALUES (1,'user2015@gmail.com', 'Random', 'Random', true, true, null, 'https://perfumeweb2.s3.eu-central-1.amazonaws.com/ae83099c-885b-499a-bb6f-5e34e1b69e7d_4ec7201fd370bd9870cdb326f0511f38.jpg', true, 1);
INSERT INTO users(id, email, full_name, username, private_profile, active, about, avatar, muted_direct_messages, pinned_tweet_id) VALUES (2,'user2016@gmail.com', 'MrCat', 'Cat', true, true, 'Hello twitter!', 'https://perfumeweb2.s3.eu-central-1.amazonaws.com/348b7dbe-3ac5-477f-8483-edc24f53091b_814370.jpg', false, null);
INSERT INTO users(id, email, full_name, username, private_profile, active, about, avatar, muted_direct_messages, pinned_tweet_id) VALUES (3,'user2017@gmail.com', 'Kitty', 'Kitty', true, true, 'Hello twitter!', 'https://perfumeweb2.s3.eu-central-1.amazonaws.com/a7e03e7c-c05f-4e30-ba8c-2271fd0b4b43_779301.jpg', true, null);
INSERT INTO users(id, email, full_name, username, private_profile, active, about, avatar, muted_direct_messages, pinned_tweet_id) VALUES (4,'user2019@gmail.com', 'JavaCat', 'JavaCat', false, true, 'Hello twitter!', 'https://perfumeweb2.s3.eu-central-1.amazonaws.com/b999d944-c9ec-4a9c-b356-db937211df5c_Ec1OBK3XsAEjVZR.png', false, null);
INSERT INTO users(id, email, full_name, username, private_profile, active, about, avatar, muted_direct_messages, pinned_tweet_id) VALUES (5,'user2018@gmail.com', 'КотБегемот', 'Кот Бегемот', false, true, 'Hello twitter!', 'https://perfumeweb2.s3.eu-central-1.amazonaws.com/68a7b0d5-2b0c-493e-85ff-098725c52ecc_Cl5DjoUWYAAslnd.jfif', false, null);
-- user_subscriptions
