...
public class UserConsumer {
    ...
    @KafkaListener(topics = MUTE_USER_TOPIC, groupId = "${spring.kafka.consumer.group-id}")
    public void userMuteListener(MuteUserEvent userEvent, @Header(AUTH_USER_ID_HEADER) String authId) {
